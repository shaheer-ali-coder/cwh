...
app.get('/user', (req, res) => {
  ...
  app.post('/bot', async (req, res) => {
    ...
    app.get('/bot',(req,res)=>{
      let absolutePath = path.join(__dirname,'/pages/childsafekit_bot.html')
      res.sendFile(absolutePath)
    })
    ...
    app.post('/email', (req, res) => {
      ...
      const time = requestData['time']
        ...
        data2.append('name',"childsafetykit")
        data2.append('source',"13")
        data2.append('status',"8")
        data2.append("title","childsafetykit Meeting")
        ...
        `
        sendEmail(email, "Confirmation | CHILD SAFETY KIT", emailText);
